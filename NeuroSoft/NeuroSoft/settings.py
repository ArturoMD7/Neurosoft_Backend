"""
Django settings for NeuroSoft project.
...
INSTALLED_APPS = [
    ...
    # Tus apps personalizadas (usuarios debe estar primero)
    'usuarios',
    'pacientes',
    'checklists',
    'estudios',
...
# Configuración para producción (ajusta según necesidades)
if not DEBUG:
...
CSRF_TRUSTED_ORIGINS = ['http://localhost']  # Solo necesario en desarrollo
